...
MozTransform:"-moz-transform",transform:"transform"};document.body.insertBefore(c,null);for(var e in b)void 0!==c.style[e]&&(c.style[e]="translate3d(1px,1px,1px)",a=window.getComputedStyle(c).getPropertyValue(b[e]));document.body.removeChild(c);return void 0!==a&&0<a.length&&"none"!==a}function C(a){var d=q;if(b.paddingTop||b.paddingBottom)a=parseInt(a.css("padding-top"))+parseInt(a.css("padding-bottom")),d=q-a;return d}function D(c){var d=c.originalEvent;c.preventDefault();a(".ms-left .ms-section.active");
h||(n=v(d).y,Math.abs(p-n)>a(window).height()/100*b.touchSensitivity&&(p>n?a.fn.multiscroll.moveSectionDown():n>p&&a.fn.multiscroll.moveSectionUp()))}function E(a){p=v(a.originalEvent).y}function v(a){var b=[];window.navigator.msPointerEnabled?(b.y=a.pageY,b.x=a.pageX):(b.y=a.touches[0].pageY,b.x=a.touches[0].pageX);return b}b=a.extend({verticalCentered:!0,scrollingSpeed:700,easing:"easeInQuart",menu:!1,sectionsColor:[],anchors:[],navigation:!1,navigationPosition:"right",navigationColor:"#000",navigationTooltips:[],
loopBottom:!1,loopTop:!1,css3:!1,paddingTop:0,paddingBottom:0,fixedElements:null,normalScrollElements:null,keyboardScrolling:!0,touchSensitivity:5,afterLoad:null,onLeave:null,afterRender:null,afterResize:null},b);var t=600,F="ontouchstart"in window||0<navigator.msMaxTouchPoints,x=a(".ms-left").find(".ms-section").length,h=!1,l,q=a(window).height();u();F&&(a(document).off("touchstart MSPointerDown").on("touchstart MSPointerDown",E),a(document).off("touchmove MSPointerMove").on("touchmove MSPointerMove",
D));b.css3&&(b.css3=B());a("html, body").css({overflow:"hidden",height:"100%"});b.navigation&&(a("body").append('<div id="multiscroll-nav"><ul></ul></div>'),l=a("#multiscroll-nav"),l.css("color",b.navigationColor),l.addClass(b.navigationPosition));a(".ms-right, .ms-left").css({width:"50%",position:"absolute",height:"100%","-ms-touch-action":"none"});a(".ms-right").css({right:"1px",top:"0"});a(".ms-left").css({left:"0",top:"0"});a(".ms-left .ms-section, .ms-right .ms-section").each(function(){var c=
a(this).index();(b.paddingTop||b.paddingBottom)&&a(this).css("padding",b.paddingTop+" 0 "+b.paddingBottom+" 0");"undefined"!==typeof b.sectionsColor[c]&&a(this).css("background-color",b.sectionsColor[c]);"undefined"!==typeof b.anchors[c]&&a(this).attr("data-anchor",b.anchors[c]);if(b.verticalCentered){var d=a(this);d.addClass("ms-table").wrapInner('<div class="ms-tableCell" style="height: '+C(d)+'px" />')}a(this).closest(".ms-left").length&&b.navigation&&(d="",b.anchors.length&&(d=b.anchors[c]),c=
b.navigationTooltips[c],"undefined"===typeof c&&(c=""),b.navigation&&l.find("ul").append('<li data-tooltip="'+c+'"><a href="#'+d+'"><span></span></a></li>'))});a(".ms-right").html(a(".ms-right").find(".ms-section").get().reverse());a(".ms-left .ms-section, .ms-right .ms-section").each(function(){var c=a(this).index();a(this).css({height:"100%"});!c&&b.navigation&&l.find("li").eq(c).find("a").addClass("active")}).promise().done(function(){a(".ms-left .ms-section.active").length||(a(".ms-right").find(".ms-section").last().addClass("active"),
a(".ms-left").find(".ms-section").first().addClass("active"));a.isFunction(b.afterRender)&&b.afterRender.call(this);r();a(window).on("load",function(){var c=window.location.hash.replace("#",""),b=a('.ms-left .ms-section[data-anchor="'+c+'"]');c.length&&f(b)})});a(window).on("hashchange",function(){var c=window.location.hash.replace("#",""),b=a(".ms-left").find('[data-anchor="'+c+'"]');"undefined"!==typeof lastScrolledDestiny&&c===lastScrolledDestiny||f(b)});a(document).keydown(function(c){if(b.keyboardScrolling&&
!h)switch(c.which){case 38:case 33:a.fn.multiscroll.moveSectionUp();break;case 40:case 34:a.fn.multiscroll.moveSectionDown()}});a(document).mousedown(function(a){if(1==a.button)return a.preventDefault(),!1});a(document).on("click","#multiscroll-nav a",function(c){c.preventDefault();c=a(this).parent().index();f(a(".ms-left .ms-section").eq(c))});a(document).on({mouseenter:function(){var c=a(this).data("tooltip");a('<div class="multiscroll-tooltip '+b.navigationPosition+'">'+c+"</div>").hide().appendTo(a(this)).fadeIn(200)},
mouseleave:function(){a(this).find(".multiscroll-tooltip").fadeOut().remove()}},"#multiscroll-nav li");b.normalScrollElements&&(a(document).on("mouseover",b.normalScrollElements,function(){a.fn.multiscroll.setMouseWheelScrolling(!1)}),a(document).on("mouseout",b.normalScrollElements,function(){a.fn.multiscroll.setMouseWheelScrolling(!0)}));a(window).resize(function(){w()});a.fn.multiscroll.moveSectionUp=function(){var c=a(".ms-left .ms-section.active").prev(".ms-section");!c.length&&b.loopTop&&(c=
a(".ms-left .ms-section").last());c.length&&f(c)};a.fn.multiscroll.moveSectionDown=function(){var c=a(".ms-left .ms-section.active").next(".ms-section");!c.length&&b.loopBottom&&(c=a(".ms-left .ms-section").first());c.length&&f(c)};a.fn.multiscroll.moveTo=function(c){var b="",b=isNaN(c)?a('.ms-left [data-anchor="'+c+'"]'):a(".ms-left .ms-section").eq(c-1);f(b)};a.fn.multiscroll.setKeyboardScrolling=function(a){b.keyboardScrolling=a};a.fn.multiscroll.setMouseWheelScrolling=function(a){a?u():document.addEventListener?
(document.removeEventListener("mousewheel",g,!1),document.removeEventListener("wheel",g,!1)):document.detachEvent("onmousewheel",g)};a.fn.multiscroll.setScrollingSpeed=function(a){b.scrollingSpeed=a};var p=0,n=0}})(jQuery);